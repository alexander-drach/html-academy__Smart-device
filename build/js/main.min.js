...
var _accordeon = require("./modules/accordeon/accordeon");
var _intro = require("./modules/intro/intro");
var _showFullTextAbout = require("./modules/about/show-full-text-about");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _intro.intro)();
  (0, _showFullTextAbout.showFullTextAbout)();
...
},{"./modules/about/show-full-text-about":2,"./modules/accordeon/accordeon":3,"./modules/form-validate/form":5,"./modules/intro/intro":11,"./modules/modals/init-modals":12,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showFullTextAbout = void 0;
var showFullTextAbout = exports.showFullTextAbout = function showFullTextAbout() {
...
var accordeon = exports.accordeon = function accordeon() {
  var accordeonToggles = document.querySelectorAll('.accordeon__toggle');
  var accordeons = document.querySelectorAll('.accordeon');
  accordeonToggles.forEach(function (item) {
...
var intro = exports.intro = function intro() {
  ...
  var changeTextIntroBtn = function changeTextIntroBtn() {
